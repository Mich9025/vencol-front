...
function HeaderTwo() {
  ...
  return (
    <div>
            ...
            <header className={`tmp-header-area-start header-two header--sticky ${isSticky ? 'sticky' : ''}`}>
                ...
                <div className="row">
                    ...
                    <div className="header-mida-area style-two">
                        ...
                        <Link href={'/'}>
                            <Image width={188} height={61} src="/assets/images/logo/logo-blue.png" alt="logo" />
                        </Link>
                        </div>
                        <Nav/>
                        <div className="button-area-header-two">
            ...
            <div className="top-area">
                ...
                <Image width={188} height={88} src="/assets/images/logo/logo-03.png" alt="logo" />
                </a>
