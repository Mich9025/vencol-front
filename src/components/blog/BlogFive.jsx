  ...
  return (
    <div>
                  ...
                  <div className="row g-5">
                      <div
                      className="col-lg-4 col-md-6 col-sm-12 col1-2" data-aos="fade-up" data-aos-delay="100">
                      ...
                      <div
                      className="col-lg-4 col-md-6 col-sm-12 col1-2" data-aos="fade-up" data-aos-delay="300">
                      <div className="single-blog">
                          <div className="blog-inner">
                          <div className="thumbnail">
                              <Link href={'/BlogDetails'}>
                      ...
                      <div
                      className="col-lg-4 col-md-6 col-sm-12 col1-2" data-aos="fade-up" data-aos-delay="500">
                      <div className="single-blog">
                          <div className="blog-inner">
                          <div className="thumbnail">
                              <Link href={'/BlogDetails'}>
