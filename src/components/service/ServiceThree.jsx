...
function ServiceThree() {
  ...
  return (
    <div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="section-head">
                        <div className="section-sub-title justify-content-center" data-aos="move-right" data-aos-delay="100">
                        <span className="subtitle color-gradiant">OUR SERVICES</span>
                        </div>
                        <h2 className="title split-collab" data-aos="move-right" data-aos-delay="300">Our Provided Services</h2>
                    </div>
                    </div>
                </div>
                    ...
                    <div className='col-lg-12'>
                        ...
                        <SwiperSlide>
                            ...
                            <div className="service-single-three">
                                ...
                                proactively envisioned multimer Dramatically top-line web.
                                </p>
                                <div className="icon">
                                <svg
                                    width={60}
                        ...
                        <SwiperSlide>
                            ...
                            <div className="service-single-three">
                                <Link href={'/ServiceDetails'}>
                                <h5 className="title">Investment Advisory</h5>
                                </Link>
                                <p className="disc">
                                Dramatically engage top-line web services vis-a-vis cutting-edge
                                proactively envisioned multimer Dramatically top-line web.
                                ...
                                >
                                    ...
                                    fill="url(#paint0_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint1_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint2_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint3_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint4_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint7_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint8_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint9_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint10_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint11_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint12_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint13_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint14_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint15_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint16_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint17_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint18_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint19_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint20_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint21_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint22_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint23_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint24_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint25_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint26_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint27_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint28_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint29_linear_289_839)"
                                    />
                                    <path
                                    ...
                                    fill="url(#paint30_linear_289_839)"
                                    />
                                    <defs>
                                    <linearGradient
                                        id="paint0_linear_289_839"
                                        x1="10.904"
                                        y1="25.8689"
                                        x2="49.0785"
                                        y2="31.5071"
                                    ...
                                    >
                                        <stop offset={1} stopColor="#ED145B" />
                                        <stop offset={1} stopColor="#4A11EB" />
                                    </linearGradient>
                                    <linearGradient
                                        id="paint1_linear_289_839"
                                        x1="46.697"
                                        y1="8.77433"
                                        x2="48.0851"
                                        y2="8.81092"
                        ...
                        <SwiperSlide>
                            ...
                            <div className="service-single-three">
                                <Link href={'/ServiceDetails'}>
                                <h5 className="title">Savings &amp; Investment</h5>
                                </Link>
                                <p className="disc">
                                Dramatically engage top-line web services vis-a-vis cutting-edge
                                proactively envisioned multimer Dramatically top-line web.
                        ...
                        <SwiperSlide>
                            ...
                            <div className="service-single-three">
                                <Link href={'/ServiceDetails'}>
                                <h5 className="title">Business Marketing</h5>
                                </Link>
                                <p className="disc">
                                Dramatically engage top-line web services vis-a-vis cutting-edge
                                proactively envisioned multimer Dramatically top-line web.
        ...
        <div className="black-shape-bottom-service"></div>
        {/* service area end */}
