...
function ServiceSix() {
  ...
  return (
    <div>
        ...
        <div className="best-service-we-provide tmp-section-gapTop">
            <div className="container">
                <div className="row g-5">
                <div
                    className="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".1s">
                    ...
                    <a href="service-details.html" className="over_link" />
                    </div>
                </div>
                <div
                    className="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".3s">
                    <div className="service-inner financial-service-inner agency-service feature-service">
                    <div className="icon">
                        <img
                ...
                <div
                    className="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".5s">
                    <div className="service-inner financial-service-inner agency-service feature-service">
                    <div className="icon">
                        <img
                ...
                <div
                    className="col-lg-3 col-md-4 col-sm-6 col-12 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".7s">
                    <div className="service-inner financial-service-inner agency-service feature-service">
                    <div className="icon">
                        <img
