                ...
                <div className="row g-5">
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="single-team">
                            ...
                            <img data-aos="move-right" data-aos-delay="0" src="assets/images/team/team-2.png" alt="Corporate team" />
                            </Link>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="single-team">
                            <Link href={'/TeamDetails'} className="thumbnail">
                                <img data-aos="move-right" data-aos-delay="0" src="assets/images/team/team-3.png" alt="Corporate team" />
                            </Link>
                            <div className="content">
                            <div className="team-name content-with-bg">
                                <Link href={'/TeamDetails'} className="name-area">
                    ...
                    className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="single-team">
                            ...
                            href={'/TeamDetails'}
                            className="thumbnail">
                            <img data-aos="move-right" data-aos-delay="0" src="assets/images/team/team-1.png" alt="Corporate team" />
                            </Link>
                            <div className="content">
                            <div className="team-name content-with-bg">
                                <Link href={'/TeamDetails'} className="name-area">
